  ...
  return (
    ...
    >
      <div
        ...
        style={{
          boxShadow:
            "0 6px 24px rgba(190,24,93,0.14), 0 2px 6px rgba(0,0,0,0.08)",
        }}
      >
        <div
          className={`w-full ${imgH} overflow-hidden relative`}
        ...
        >
          <Image
            ...
            sizes={mobile ? "96px" : "176px"}
          />
        </div>
        <p
          className={`text-center ${txt} mt-1.5 italic tracking-wide font-serif`}
...
export default function LandingHero({ onEnter }: LandingHeroProps) {
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(145deg, #FFF0F7 0%, #FCE7F3 30%, #F5F0FF 70%, #EDE9FE 100%)",
      }}
    >
      <MusicToggle />
      ...
      <div
        className="absolute -top-20 left-1/3 w-[500px] h-[400px] rounded-full blur-[100px] pointer-events-none"
        style={{ background: "rgba(249,168,212,0.22)" }}
      />
      <div
        className="absolute bottom-0 right-1/4 w-[400px] h-[350px] rounded-full blur-[80px] pointer-events-none"
        style={{ background: "rgba(196,181,253,0.18)" }}
      />
      <div
        className="absolute top-1/2 left-0 w-[250px] h-[300px] rounded-full blur-[70px] pointer-events-none"
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-6 py-20">
        ...
        >
          ...
          >
            Un pequeño refresh de los cupones para que lo uses mas. Welcome to
            version 2.0!
          </motion.p>
